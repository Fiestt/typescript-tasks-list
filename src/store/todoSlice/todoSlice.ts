...
export const { addTodo, getNewTodos, getNewCompletedTodos, handleDoneActive, handleDoneCompleted, handleDeleteActive, handleDeleteCompleted, acceptEditActiveTodo, acceptEditCompletedTodo} = todoSlice.actions
